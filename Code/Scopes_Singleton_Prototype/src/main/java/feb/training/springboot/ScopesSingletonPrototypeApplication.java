...
import feb.training.springboot.singletontest.OrderService;
...
public class ScopesSingletonPrototypeApplication {
	...
	public static void main(String[] args) {
		  ...
		  OrderService obj1  =(OrderService) context.getBean("singletontest");
		 ...
		 // System.out.println(obj1);
			 ...
			 */
			/*
			 * System.out.println("Prototype Into Singleton"); OrderService
			 * service1=(OrderService) context.getBean("protosingle"); OrderService
			 * service2=(OrderService) context.getBean("protosingle");
