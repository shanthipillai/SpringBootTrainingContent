...
public class AccountService {
	 ...
	 * 
	 * 
	 * System.out.println("📦 Account fetched - Thread: " +
	 * Thread.currentThread().getName());
	 * 
	 * // Step 2: Call Cards Service long cardsStart = System.currentTimeMillis();
	 * 
	 * 
	 * System.out.println("💳 Calling Cards Service - Thread: " +
	 * Thread.currentThread().getName());
	 * 
	 ...
	 * 
	 * 
	 * System.out.println("✅ Cards Response - Time: " + (cardsEnd - cardsStart) +
	 * " ms | Thread: " + Thread.currentThread().getName());
	 * 
	 * // Step 3: Call Loans Service long loansStart = System.currentTimeMillis();
	 * System.out.println("🏦 Calling Loans Service - Thread: " +
	 * Thread.currentThread().getName());
	 * 
	 ...
	 * 
	 * System.out.println("✅ Loans Response - Time: " + (loansEnd - loansStart) +
	 * " ms | Thread: " + Thread.currentThread().getName());
	 * 
	 * long endTime = System.currentTimeMillis();
	 * 
	 * System.out.println( "🏁 END - Total Time: " + (endTime - startTime) +
	 * " ms | Thread: " + Thread.currentThread().getName());
	 * 
	 * return new AccountSummary(account, cards, loans); }
	 */
