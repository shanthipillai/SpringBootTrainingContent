...
import feb.training.springboot.exceptions.DuplicateRecord;
...
@Tag(name = "Employee API V1", description = "Operations related to users")
public class EmployeeControllerV1 {
	...
	public ResponseEntity<String> handleDuplicateRecord(DuplicateRecord ex)
	{
