...
@WebServlet(
	    urlPatterns = "/genservlet1",
	    initParams = {
	      @WebInitParam(name = "course", value = "Spring Boot"),
	        @WebInitParam(name = "trainer", value = "Shanthi")
	    }
	   ) 
...
public class GenericServlet1 extends GenericServlet {
	  ...
	  System.out.println("👉 init() method called - Servlet Created by 1");
	  ...
	  System.out.println("👉 service() method called - Handling Request 1");
	  ...
	  System.out.println("👉 destroy() method called - Servlet Destroyed 1"); try{
